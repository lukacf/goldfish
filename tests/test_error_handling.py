...
class TestConfigYAMLErrors:
    ...
    def test_handles_malformed_yaml(self, temp_dir):
        ...
        assert "yaml" in str(exc_info.value).lower() or "parse" in str(exc_info.value).lower() or "config" in str(exc_info.value).lower()
    ...
    def test_handles_invalid_config_structure(self, temp_dir):
        ...
        assert "config" in str(exc_info.value).lower() or "invalid" in str(exc_info.value).lower() or "required" in str(exc_info.value).lower()

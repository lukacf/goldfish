...
class TestSnapshotIdValidation:
    ...
    def test_rejects_command_injection_attempts(self):
        ...
        from goldfish.validation import validate_snapshot_id, InvalidSnapshotIdError
...
class TestOutputNameValidation:
    ...
    def test_rejects_path_traversal_attempts(self):
        ...
        from goldfish.validation import validate_output_name, InvalidOutputNameError
...
class TestFromRefValidation:
    ...
    def test_rejects_dangerous_refs(self):
        ...
        from goldfish.validation import validate_from_ref, InvalidRefNameError
...
class TestPromoteArtifactUsesValidation:
    ...
    def test_promote_artifact_validates_output_name(self, temp_dir):
        ...
        try:
            promote_fn = server.promote_artifact.fn if hasattr(server.promote_artifact, 'fn') else server.promote_artifact

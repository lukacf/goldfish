...
from goldfish.models import SlotState, DirtyState
...
class TestWorkspaceLifecycleWorkflow:
    ...
    def test_create_workspace_workflow(self, e2e_setup):
        ...
        result = manager.create_workspace(
            ...
            reason="Starting work on feature X implementation"
        )
    ...
    def test_mount_unmount_workflow(self, e2e_setup):
        ...
        manager.create_workspace(
            name="mount-test",
            goal="Test mounting",
            reason="Testing mount workflow"
        )

        # Mount to slot
        mount_result = manager.mount(
            workspace="mount-test",
            slot="w1",
            reason="Mounting for testing"
        )
    ...
    def test_edit_and_checkpoint_workflow(self, e2e_setup):
        ...
        manager.create_workspace(
            ...
            reason="Testing checkpoint workflow"
        )
    ...
    def test_rollback_workflow(self, e2e_setup):
        ...
        rollback_result = manager.rollback(
            slot="w1",
            snapshot_id=first_checkpoint.snapshot_id,
            reason="Rolling back to fix bugs"
        )
...
class TestMultiSlotWorkflow:
    ...
    def test_multiple_workspaces_parallel(self, e2e_setup):
        ...
        manager.create_workspace(
            name="feature-a",
            goal="Feature A",
            reason="Working on feature A"
        )
        manager.create_workspace(
            name="feature-b",
            goal="Feature B",
            reason="Working on feature B"
        )
    ...
    def test_switch_workspace_in_slot(self, e2e_setup):
        ...
        manager.create_workspace(
            name="ws-alpha",
            goal="Alpha workspace",
            reason="Creating alpha workspace"
        )
        manager.create_workspace(
            name="ws-beta",
            goal="Beta workspace",
            reason="Creating beta workspace"
        )
...
class TestSnapshotWorkflow:
    ...
    def test_list_snapshots_workflow(self, e2e_setup):
        ...
        manager.create_workspace(
            name="snapshot-list",
            goal="Test listing",
            reason="Testing snapshot listing"
        )
...
class TestDatabasePersistenceWorkflow:
    ...
    def test_workspace_audit_log_persistence(self, e2e_setup):
        ...
        manager.create_workspace(
            ...
            reason="Testing goal persistence"
        )
    ...
    def test_workspace_survives_mount_unmount(self, e2e_setup):
        ...
        manager.create_workspace(
            name="survive-test",
            goal="Survival test",
            reason="Testing workspace survival"
        )
...
class TestDiffWorkflow:
    ...
    def test_diff_shows_uncommitted_changes(self, e2e_setup):
        ...
        manager.create_workspace(
            name="diff-workflow",
            goal="Test diff",
            reason="Testing diff functionality"
        )
    ...
    def test_diff_empty_after_checkpoint(self, e2e_setup):
        ...
        manager.create_workspace(
            name="diff-clean",
            goal="Test clean diff",
            reason="Testing clean diff state"
        )
...
class TestErrorRecoveryWorkflow:
    ...
    def test_double_mount_same_slot_fails(self, e2e_setup):
        ...
        manager.create_workspace(
            name="first-ws",
            goal="First",
            reason="Creating first workspace"
        )
        ...
        manager.create_workspace(
            name="second-ws",
            goal="Second",
            reason="Creating second workspace"
        )
    ...
    def test_rollback_to_invalid_snapshot_fails(self, e2e_setup):
        ...
        with pytest.raises(GoldfishError):
            manager.rollback(
                slot="w1",
                snapshot_id="snap-nonexistent-00000000-000000",

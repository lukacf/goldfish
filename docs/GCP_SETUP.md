...
**Location**: `gs://mlm-artifacts-king-dev/wheels/flash_attn_3-3.0.0b1-cp39-abi3-linux_x86_64.whl`
...
docker:
  cloud_build:
    fa3_wheel_gcs: gs://mlm-artifacts-king-dev/wheels/flash_attn_3-3.0.0b1-cp39-abi3-linux_x86_64.whl
```
...
gcloud compute ssh fa3-build-* --zone=us-central1-a --command='
  ...
  gsutil cp /tmp/wheels/flash_attn_3*.whl gs://mlm-artifacts-king-dev/wheels/
'
